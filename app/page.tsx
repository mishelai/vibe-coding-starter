...
export default function Page() {
  return (
    <div className="min-h-screen bg-primary-100 dark:bg-secondary-900 overflow-x-hidden w-full">
      ...
      <main className="xl:pt-6 xl:pb-6 xl:px-6 w-full overflow-hidden">
        <div className="bg-primary-100 dark:bg-secondary-900 min-h-screen w-full">
          <MentorHeader />
          <MentorHero />
          <AboutSection />
          <TestimonialsSection />
